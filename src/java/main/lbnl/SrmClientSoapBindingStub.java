...
public class SrmClientSoapBindingStub extends org.apache.axis.client.Stub implements lbnl.SrmClient {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "srmPingReturn"));
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "srmCopyReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "srmGetReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[2] = oper;
    ...
    public SrmClientSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public SrmClientSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public SrmClientSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public java.lang.String srmPing(java.lang.String in0) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("lbnl", "srmPing"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0});
  ...
  throw axisFaultException;
    ...
    public java.lang.String srmCopy(java.lang.String in0, java.lang.String in1, java.lang.String in2) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("lbnl", "srmCopy"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1, in2});
  ...
  throw axisFaultException;
    ...
    public java.lang.String srmGet(java.lang.String in0, java.lang.String in1) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("lbnl", "srmGet"));
